...
class RemoveUserFromPendingMemberMaillists implements ShouldQueue
{
    ...
    public function handle(MailListFacade $mailListFacade)
    {
        ...
        $mailListFacade->removeUserFromSpecifiedMailLists($this->user->email, $pendingMemberMailLists);
    }
}
