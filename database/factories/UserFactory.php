...
class UserFactory extends Factory
{
    public function definition(): array
    {
        ...
        return [
            ...
            'emergencyfirstname' => fake()->name(),
            'emergencylastname' => fake()->name(),
            'emergencyrelation' => fake()->randomElement(["Parent", "Sibling", "Partner", "Friend", "Grandparent", "Aunt / Uncle", "Cousin", "Guardian", "Other"]),
            'birthday' => fake()->date(),
