...
return [
    "signupexpired" => "The sign up date has expired",
    "duplicatesignup" => "You have already signed up for this event",
    "applicationformTitle" => "Application form :name",
    "applicationFormUser" => "Member who will be registered:",
