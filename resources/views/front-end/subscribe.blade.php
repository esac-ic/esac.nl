            ...
            <div class="accordion" id="accordion-1" data-children=".accordion-item">
                ...
                <div class="accordion-item">
                    ...
                    <div id="accordion-panel-4" class="collapse" role="tabpanel">
                        <ul>
                            <li>
                                We are an association together and with each other we ensure that everything stays fun.
                                We treat each other respectfully, everybody can join in and be themselves. That is why
                                this code of conduct has been established, and everyone has to comply with it.
                            </li>
                            <li>
                                More information about social safety in ESAC can be found
                                <a href="{{ url(\App\MenuItem::SOCIALSAFETYURL) }}" target="_blank">here</a>.
                            </li>
                        </ul>
