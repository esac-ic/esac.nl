            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        {!! Form::select('shirt_size','Array', $registrationInfo->shirt_size, ['class' => 'form-control']) !!}
                    </div>
                    <div class="form-group col-md-6">
                        {!! Form::label('intro_weekend_date', 'Intro weekend') !!}
                        {!! Form::select('intro_weekend_date','Array', $registrationInfo->intro_weekend_date != null ? $registrationInfo->intro_weekend_date->format('Y-m-d') : null, ['class' => 'form-control']) !!}
                    </div>
                </div>
            </div>
        </div>
