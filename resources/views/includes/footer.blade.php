        ...
        <div class="row">
            <div class="col-12 col-md-3">
                ...
                <p class="font-size-180">
                    ...
                    <span class="p-1"><a
                                href="https://www.instagram.com/esac.nl/" class="ion-social-instagram"></a></span>
                    <span class="p-1"><a
                                href="https://www.youtube.com/channel/UCn6jb9BA10f-rbvinYCYlxA/"
            ...
            <div class="col-12 col-md-9">
                ...
                <div class="row">
                    <div class="col-6 col-lg-3">
                        <a href="https://venusp.tue.nl/sci-cgi/index.opl"><img
                                    class="img-fluid" src="{{asset('img/ssc.png')}}"></a>
                    </div>
                    <div class="col-6 col-lg-3">
                        <a href="https://www.neoliet.nl"><img class="img-fluid" src="{{asset('img/neoliet.png')}}"></a>
                    </div>
                    <div class="col-6 col-lg-3">
                        <a href="https://www.klimwinkel.nl"><img
                                    class="img-fluid" src="{{asset('img/klimwinkel.png')}}"></a>
                    </div>
                </div>
            </div>
        </div>
