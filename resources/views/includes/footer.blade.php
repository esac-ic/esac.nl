        ...
        <div class="row">
            ...
            <div class="col-12 col-md-9">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-6 col-lg-3">
                        <a href="https://ad.zanox.com/ppc/?41202979C70976818T"><img class="img-fluid" src="{{mix('img/bever.png')}}"></a>
                    </div>
                    <div class="col-6 col-lg-3">
                        <a href="https://ad.zanox.com/ppc/?41266315C16320781T"><img class="img-fluid" src="{{mix('img/decathlon.png')}}"></a>
                    </div>
                </div>
            </div>
        </div>
