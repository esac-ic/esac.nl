        ...
        <div class="row">
            <div class="col-12 col-md-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 510.24 259" class="logo logo-esac" fill="white">
                    ...
                    <path class="cls-1"
                          d="M5.55 177.69L186.74 32.43M186.74 32.43l63.64 42.09M250.38 74.52l5.65-5.65M256.03 68.87L186.74 22.7M186.74 22.7L5.55 169M5.55 169v8.69"/>
                    <path d="M294.01 8.51l114.97 115.28-6.16 5.65L294.01 19.6l-50.1 41.2-6.55-4.37 56.65-47.92z"/>
                    <path class="cls-1"
                          d="M402.82 129.44l6.16-5.65M243.91 60.8l50.1-41.2M294.01 19.6l108.81 109.84M408.98 123.79L294.01 8.51M294.01 8.51l-56.65 47.92M237.36 56.43l6.55 4.37"/>
                    <path d="M504.45 137.45v8.93l-80.07-80.07-40.45 32.36-6.1-6.12 46.55-36.12 80.07 81.02z"/>
                    <path class="cls-1"
                          d="M504.45 137.45v8.93M383.93 98.67l40.45-32.36M424.38 66.31l80.07 80.07M377.83 92.55l46.55-36.12M424.38 56.43l80.07 81.02M377.83 92.55l6.1 6.12"/>
                </svg>
                <p class="text-muted mt-4">
                    ...
                    <br>Alpen Club
                    <br><br>
                    T: {{ app(\App\Models\Setting::SINGELTONNAME)->getsetting(\App\Models\Setting::SETTING_FOOTER_PHONE_NR) }}
                ...
                <p class="font-size-180">
                    ...
                    <span class="p-1"><a href="https://www.instagram.com/esac.nl/"
                                         class="ion-social-instagram"></a></span>
                    <span class="p-1"><a href="https://www.youtube.com/channel/UCn6jb9BA10f-rbvinYCYlxA/"
                                         class="ion-social-youtube"></a></span>
                </p>
            </div>
            <div class="col-12 col-md-9">
                ...
                <div class="row">
                    <div class="col-6 col-lg-3">
                        <a href="https://venusp.tue.nl/sci-cgi/index.opl"><img class="img-fluid"
                                                                               src="{{asset('img/ssc.png')}}"></a>
                    </div>
                    <div class="col-6 col-lg-3">
                        <a href="https://www.neoliet.nl"><img class="img-fluid" src="{{asset('img/neoliet.png')}}"></a>
                    </div>
                    <div class="col-6 col-lg-3">
                        <a href="https://www.klimwinkel.nl"><img class="img-fluid"
                                                                 src="{{asset('img/klimwinkel.png')}}"></a>
                    </div>
                </div>
            </div>
        </div>
