...
class HandleOldMemberBecameMemberTest extends \TestCase
{
    use RefreshDatabase;
     ...
     */
    public function test_old_member_becomes_normal_member()
    {
        ...
        $event = new OldMemberBecameMember($this->user);
        
        $listener->handleOldMemberBecameMember($event);
    }
    
    public function test_old_member_becomes_reunist()
    {
        $this->mockedMailListFacade->shouldNotReceive('removeUserFromSpecifiedMailLists');
    ...
    public function test_old_member_becomes_extraordinary_participant()
    {
        $this->mockedMailListFacade->shouldNotReceive('removeUserFromSpecifiedMailLists');
    ...
    public function test_old_member_becomes_honorary_member()
    {
        $this->mockedMailListFacade->shouldNotReceive('removeUserFromSpecifiedMailLists');
    ...
    public function test_old_member_becomes_member_of_merit()
    {
        $this->mockedMailListFacade->shouldNotReceive('removeUserFromSpecifiedMailLists');
    ...
    public function test_old_member_becomes_trainer()
    {
        $this->mockedMailListFacade->shouldNotReceive('removeUserFromSpecifiedMailLists');
    ...
    public function test_old_member_becomes_relationship()
    {
        $this->mockedMailListFacade->shouldNotReceive('removeUserFromSpecifiedMailLists');
